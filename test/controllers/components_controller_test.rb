...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { content: @component.content, order: @component.order, position_id: @component.position_id, title: @component.title } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { content: @component.content, order: @component.order, position_id: @component.position_id, title: @component.title } }
