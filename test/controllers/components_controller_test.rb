...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { active: @component.active, content: @component.content, order: @component.order, title: @component.title } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { active: @component.active, content: @component.content, order: @component.order, title: @component.title } }
