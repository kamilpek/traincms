...
User.create!([
  {email: 'user4@pl', encrypted_password: '$2a$11$plDrpEk4ndTp9uhoP81/ie9JCvBBmeYbCCrXcxgs5eC15gseAY9QK', password: 'userpl', reset_password_token: nil, reset_password_sent_at: nil, sign_in_count: 4, current_sign_in_at: "2017-02-11 11:30:23", last_sign_in_at: "2017-02-11 11:29:28", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", admin: false, first_name: "Kamil", last_name: "Pek", confirmation_token: nil, confirmed_at: "2017-02-21 18:20:54", confirmation_sent_at: nil},
  {email: 'kamil.pek@gmail.com', encrypted_password: '$2a$11$lK.Bey6/JhgTySho/knGQuCG2yTNo4dlAwEryLrZHA5jKgAKeOoE2', password: 'adminpl', reset_password_token: nil, reset_password_sent_at: nil, sign_in_count: 41, current_sign_in_at: "2017-02-25 07:25:09", last_sign_in_at: "2017-02-23 16:24:26", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", admin: true, first_name: nil, last_name: nil, confirmation_token: nil, confirmed_at: "2017-02-21 18:20:54", confirmation_sent_at: nil}
])
...
Event.create!([
  ...
  {title: "Podróż Newag 222M", content: "<p>Przejażdżka Newag 222M</p>\r\n", active: true, highlight: false, visit: nil, followers: nil, term: "2017-02-27", user_id: 1, image: "newag-222m.jpg"}
])
...
Article.create!([
  ...
  {title: "35WE", category_id: 1, active: true, intro: "<h5>Newag Impuls</h5>\r\n", content: "<p>35WE-001F</p>\r\n", visit: 154, highlight: false, user_id: 1, image: "newagimpuls.JPG"},
...
Comment.create!([
  {article_id: 1, author: "majster", content: "super artykuł", email: nil, ip: "127.0.0.1"},
  {article_id: 2, author: "Zwiedzający", content: "Mocne 9/11", email: nil, ip: "127.0.0.1"}
])
...
TagRef.create!([
  ...
  {tag_id: 3, article_id: 2}
])
p "Created #{TagRef.count} tagrefs."
